       ...
       <div id="header">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="header-img">
                            <img src="{{ asset('frontend/img/watch-header.png') }}" alt="Product Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="product-img">
                            <img src="{{ asset('frontend/img/watch-features.png') }}" alt="Product Image">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="product-feature">
        ...
        <div id="products">
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="product-single mb-5">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/' . $product->image) }}" width="200" height="200" alt="Product Image">
                            </div>
                            <div class="product-content">
                ...
                <div class="mt-5 text-center"><a href="{{ route('products') }}" class="btn btn-primary">show all</a></div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="contact-info">
                            ...
                            <div class="social">
                                <a href="http://facebook.com/amar.ebrahim.127"><i class="fab fa-twitter"></i></a>
